...
;(function (global, factory) {
    ...
    var jexcel = (function(el, options) {
         ...
         * @return null
         */
        obj.jsonExport = function(includeHeaders) {
            if (obj.options.allowExport == false) {
                console.error('Export not allowed');
            } else {
                // Data
    ...
    jexcel.methods.engineering = (function() {
        ...
        exports.CONVERT = function(number, from_unit, to_unit) {
            ...
            var units = [
                ...
                ["A¡ÍngstrA¢Òm", "A¡¦", ["ang"], "length", false, true, 1e-10],
                ...
                ["cubic A¡ÍngstrA¢Òm", "ang3", ["ang^3"], "volume", false, true, 1e-30],
                ...
                ["degree", "A¡Æ", null, "angle", false, false, 0.0174532925199433],
                ...
                ["A¡°rsted", "Oe ", null, "magnetic_field_intensity", false, false, 79.5774715459477],
                ["ohm", "I¨Ï", null, "electric_resistance", true, false, 1],
                ["ounce mass", "ozm", null, "mass", false, true, 0.028349523125],
                ["pascal", "Pa", null, "pressure", true, false, 1],
                ["pascal second", "Pa?s", null, "dynamic_viscosity", true, false, 1],
                ["pferdestA¢´rke", "PS", null, "power", false, true, 735.49875],
                ...
                ["square A¡ÍngstrA¢Òm", "ang2", ["ang^2"], "area", false, true, 1e-20],
