...
joint.shapes.org.Member = joint.dia.Element.extend({
	...
	markup: ['<g class="rotatable">',
	         ...
	         '		<image class="delete"/>',
	         '	</g>',
	         '	<text class="answerTxt"/>',
	         '	<text class="questionTxt"/>',
	         '</g>'
	         ].join(''),
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            ...
            '.update': {
            	width: 10, height: 10,
                ref: '.card', 'ref-x': 140, 'ref-y': 8,
                'onclick':'javascript:updateMember(this);'
            },
            
            '.delete': {
            	width: 10, height: 10,
                ref: '.card', 'ref-x': 160, 'ref-y': 8,
                'onclick':'javascript:removeMember(this);'
            },
            
            '.answerTxt': {
                'text-decoration': 'underline',
                ref: '.card', 'ref-x': 0.1, 'ref-y': 0.3,
            ...
            '.questionTxt': {
                ...
                'font-family': 'Courier New', 'font-size': 13,
                'text-anchor': 'start'
            }
        }
    }, joint.dia.Element.prototype.defaults)
...
joint.shapes.org.Arrow = joint.dia.Link.extend({
    ...
    defaults: {
        ...
        attrs: { '.connection': { stroke: '#585858', 'stroke-width': 3 }, '.marker-target': { d: 'M 10 0 L 0 5 L 10 10 z' }},
        z: -1
    }
});
