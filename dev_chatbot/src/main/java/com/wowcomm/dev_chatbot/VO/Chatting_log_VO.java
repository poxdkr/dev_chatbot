...
public class Chatting_log_VO {
	...
	public String toString() {
		return "Chatting_log_VO [seq_num=" + seq_num + ", gubun=" + gubun + ", user_id=" + user_id + ", kind=" + kind
				...
				+ ", upload_files=" + upload_files + ", ai_percent=" + ai_percent + ", ai_msg=" + ai_msg
				+ ", ai_msg_img=" + ai_msg_img + ", ai_msg_find=" + ai_msg_find + ", scenario_id=" + scenario_id
				+ ", scn_code=" + scn_code + ", state=" + state + ", msg_state=" + msg_state + ", isview=" + isview
				+ ", keyword_check=" + keyword_check + ", regdate=" + regdate + ", sysdate=" + sysdate + ", dayofweek="
				+ dayofweek + "]";
	}
